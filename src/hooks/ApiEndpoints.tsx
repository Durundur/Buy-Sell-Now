...
export const GET_USER_ADS_URL = (searchPathAndParams: string) => {return `api/v1/ads/user/${searchPathAndParams}`};
export const GET_USER_PAGE_ADS_STATS_URL = (userId: string) => {return `api/v1/ads/user/${userId}/stats`};
export const GET_USER_PAGE_INFO_URL = (userId: string) => {return `api/v1/ads/user/${userId}/info`};
