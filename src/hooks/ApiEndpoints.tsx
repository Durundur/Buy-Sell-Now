...
export const GET_AD_URL = (adId: string) => {return `api/v1/adverts/${adId}`};
export const UPDATE_AD_URL = (adId: string) => {return `api/v1/adverts/${adId}`};
export const DELETE_AD_URL = (adId: string) => {return `api/v1/adverts/${adId}`};
