        ...
        <Box pb={10} color={'blue.900'} bg={'gray.50'}>
            <Container maxW={{md:'container.md', lg:'container.lg', xl:'container.xl'}} >
                <Flex gap={'20px'}>
                    ...
                    <Box width={'70%'}  bg={'#fff'} borderRadius={'20px'} padding={'20px'}>
                        <Carousel cards={ad.imgs}></Carousel>
                    </Box>
                    <Box bg={'#fff'} borderRadius={'20px'} width={'100%'} padding={'20px'}>
                        ...
                        <Box ><iframe src="https://maps.google.com/maps?q=Warszawa%20Mokot%C3%B3w+(My%20Business%20Name)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></Box>
                    </Box>
                    <Box bg={'#fff'} borderRadius={'20px'}  padding={'20px'}>
                ...
                {/* OPIS */}
                <Stack mt={'20px'} bg={'#fff'} borderRadius={'20px'} width={'70%'} padding={'20px'}>
                ...
                <Box mt={'20px'} bg={'#fff'} borderRadius={'20px'}  padding={'20px'}>
